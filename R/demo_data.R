...
# is what tti_prepare() and the benchmarking functions take. Presenting it
...
#'
#' @description
#' Returns `taxa_demo` in the form [tti_run()] expects: an abundance matrix
...
#' run$missing
#'
#' @seealso [taxa_demo] for the stored form, used by [tti_prepare()].
#'
#' @export
tti_demo_data <- function() {
